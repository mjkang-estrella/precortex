        ...
        <div class="h-full flex flex-col min-h-0">
            <header class="px-4 py-4 sm:px-6 sm:py-6 lg:px-10 lg:py-8 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-end flex-shrink-0 z-10 bg-white">
                ...
                <div class="flex gap-2 self-start sm:self-auto">
                    <button class="flex items-center gap-2 px-4 py-2 rounded-full bg-stone-50 hover:bg-stone-100 text-stone-700 hover:text-stone-900 text-sm font-medium transition-colors border border-stone-200/60 lowercase" type="button" aria-label="share today">
