...
export function buildInitialTasks() {
    return [
        ...
        },
        {
            ...
            description:
                "Draft the quarter plan, pressure-test the core themes, and line up the first review with the team.",
            project: "inbox",
            priority: "none",
        ...
        },
        {
            ...
            description:
                "Compare the strongest proposals, note budget tradeoffs, and leave with a shortlist for the next meeting.",
            project: "inbox",
            priority: "high",
        ...
        },
        {
            ...
            description:
                "Fold the latest stakeholder feedback into the guidance so the team can use one consistent voice.",
            project: "inbox",
            priority: "medium",
        ...
        },
        {
            ...
            tags: [],
            description:
                "Restock the standard desk setup so the onboarding area is ready for the next new hire.",
            project: "ops",
            priority: "none",
            createdLabel: "created yesterday",
        ...
        },
        {
            ...
            tags: [],
            description:
                "Send the Friday wrap-up with wins, blockers, and next steps for next week.",
            project: "ops",
            priority: "none",
            createdLabel: "created yesterday",
